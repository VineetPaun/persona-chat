...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    if (storedPersona) {
      ...
      updateMemoryStats(parsedPersona.id)
      return
    }
    ...
    if (foundPersona) {
      ...
      updateMemoryStats(foundPersona.id)
      return
    }
    ...
    try {
      ...
      if (customPersona) {
        ...
        updateMemoryStats(customPersona.id)
        return
      }
    } catch (error) {
  ...
  const clearMemories = () => {
    ...
    if (confirm(`Are you sure you want to clear all memories for ${persona.name}? This action cannot be undone.`)) {
      memoryStore.clearMemories(persona.id)
      updateMemoryStats(persona.id)
    }
  }
